...
@pytest.mark.TestSeachListResolve123
class TestSeachListResolve123:
    ...
    def test_sl_13(self, api_client, common_functions, op_path, dbo):
        """"TC 13 - Create Dynamic Search List with Categories Type AmaZOn Linux"""
    ...
    def test_sl_14(self, api_client, common_functions, op_path, dbo):
        """TC 14 - Create Dynamic Search List with Categories Type backdrops_and_trojan_horses"""
    ...
    def test_sl_66(self, api_client, common_functions, op_path, dbo):
        """TC 68 - Create Dynamic Search List with Exploitability exploitkits"""
    ...
    def test_sl_69(self, api_client, common_functions, op_path, dbo):
        """TC 71 - Create Dynamic Search List with Exploitability Immunity Dsquare"""
        params = {"exploitability": "Core Security"}
        sl_id_qweb = SeachList.create_dynamic_search_list(api_client, params, 'qweb')
        print("Created: SL-QWEB", sl_id_qweb)
        sl_id_service = SeachList.create_dynamic_search_list(api_client, params, 'qid')
    ...
    def test_sl_70(self, api_client, common_functions, op_path, dbo):
        """TC 72 - Create Dynamic Search List with Exploitability Immunity Enable Security"""
    ...
    def test_sl_71(self, api_client, common_functions, op_path, dbo):
        """TC 73 - Create Dynamic Search List with Exploitability immunity_white_phosphourus"""
    ...
    def test_sl_72(self, api_client, common_functions, op_path, dbo):
        """TC 74 - Create Dynamic Search List with Exploitability Metasploit"""
    ...
    def test_sl_73(self, api_client, common_functions, op_path, dbo):
        """TC 75 - Create Dynamic Search List with Exploitability Qualys"""
    ...
    def test_sl_74(self, api_client, common_functions, op_path, dbo):
        """TC 76 - Create Dynamic Search List with Exploitability the_exploit_db"""
    ...
    #     pre_update_res = SeachList.get_qid_list_from_xml(SeachList.get_qweb_search_list(api_client, common_functions, "qweb", sl_id))
    #     qid_to_change = pre_update_res[0]
    #     print("QID picked up for updation :",  qid_to_change)
    #     print(SeachList.get_qid_sevirity(SeachList.qid_update_or_list(api_client, qid_to_change, "qweb", "list")))
    #     SeachList.qid_update_or_list(api_client, qid_to_change, "qweb")
    #     post_update_res = SeachList.get_qid_list_from_json(SeachList.get_qid_service_search_list(api_client, common_functions,sl_id))
    #     print(res[0])
    #     for id in res:
    #         if id == qid_to_change:
    #             print(id)
    ...
    #     params = {"discovery_methods": "Remote"}
    #     sl_id = SeachList.create_dynamic_search_list(api_client, params, 'qweb')
    #     print("Created: SL-QWEB", sl_id)
    #     sl_id = SeachList.create_dynamic_search_list(api_client, params, 'qid')
    #     print("Created: SL-QID", sl_id)


    # """Test SearchList Resolve Bulk -"""
    # def test_sl_01(self, api_client, common_functions, op_path, dbo):
    #     """TC 01 - Create Dynamic Search List with Discovery Methods - Remote"""
    #     SeachList.verify_all_dynamic_sl_in_subscription(api_client,common_functions,dbo)
    #     #sl_id="1788216,1788215,1788214,1788212,1788211,1788206"
    #     #sl_id="1788216"
    #     #print(sl_id)
    #     #assert SeachList.verify_qids_bulk_resolve(sl_id, api_client, common_functions), "Invalid QIDs Found"
    #     #SeachList.delete_dynamic_search_list(sl_id, api_client)
